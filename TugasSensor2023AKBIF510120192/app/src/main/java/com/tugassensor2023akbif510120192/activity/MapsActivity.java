...
import com.tugassensor2023akbif510120192.databinding.ActivityMapsBinding;
                ...
                for (Location location : locationResult.getLocations()) {
                    if (location != null) {
                        ...
                        StringBuilder stringBuilder = new StringBuilder("https://serpapi.com/search.json?" +
                                ...
                                "ll=@" + lat + "," + lng + ",19z&" +
                                "type=search" +
                                "&api_key=c11b13abfc100c6cbcadeb48f345ab729965140ae691cc21c0adb501b5210a2b");
                        ...
                        Toast.makeText(MapsActivity.this, "mencari", Toast.LENGTH_LONG).show();
                    }
                }
            }
        };
